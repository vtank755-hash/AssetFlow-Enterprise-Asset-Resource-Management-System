...
<div class="container-fluid py-4">
    <div class="mb-4">
        ...
        <h1 class="h3 mt-2 mb-0 fw-bold">Add Department</h1>
        <p class="text-muted">Register a new business division or department division within the company hierarchy.</p>
    </div>
        ...
        <div class="col-lg-6">
            ...
            <div class="card shadow-sm border-0">
                <div class="card-body p-4">
                    <form action="<?php echo BASE_URL; ?>/departments/create" method="POST">
                        <input type="hidden" name="csrf_token" value="<?php echo Session::generateCSRFToken(); ?>">

                        <div class="mb-3">
                            <label for="name" class="form-label fw-semibold">Department Name <span class="text-danger">*</span></label>
                            <input type="text" class="form-control" id="name" name="name" required placeholder="e.g. Human Resources">
                        </div>

                        <div class="mb-4">
                            <label for="code" class="form-label fw-semibold">Department Code <span class="text-danger">*</span></label>
                            <input type="text" class="form-control font-monospace" id="code" name="code" required placeholder="e.g. HR" maxlength="10">
