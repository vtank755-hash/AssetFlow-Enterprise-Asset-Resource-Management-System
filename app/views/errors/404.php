...
<head>
    ...
    <title>404 Page Not Found - AssetFlow</title>
    <!-- Bootstrap 5 CSS -->
...
<body class="auth-bg">
    <div class="auth-card text-center" style="max-width: 500px;">
        ...
        <h1 class="fw-bold mb-2 display-6">404</h1>
        <h3 class="fw-semibold mb-3">Page Not Found</h3>
        <p class="text-muted mb-4">The link you followed may be broken, or the page may have been removed from the resource management system.</p>
